...
- [CropEditor Architecture](crop-editor-architecture.md) — unified crop/frame editor (fixed window, image pans/zooms); avatar WYSIWYG fix via avatarCropX/Y/W/H DB columns.
