...
function EditPetForm({ pet, petId, topInset, colors, insets }: EditPetFormProps) {
  ...
  // Resolved display name for the selected breed — drives the summary row
            ...
            {breedsLoading ? (
              ...
              <>
                ...
                <TouchableOpacity
                  ...
                  style={[s.breedSummaryRow, { borderColor: colors.border }]}
                  activeOpacity={0.7}
                  accessibilityRole="button"
...
const s = StyleSheet.create({
  ...
  // Breed summary row (collapsed picker on the edit screen)
  breedSummaryRow: {
    flexDirection:     'row',
    alignItems:        'center',
